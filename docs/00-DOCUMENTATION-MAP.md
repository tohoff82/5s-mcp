...
- Verification state: current uncommitted worktree; replace `last_verified_commit` metadata with the final commit hash before release.
- Package and MCP handshake: `5s-mcp@1.0.0`.
